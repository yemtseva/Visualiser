...
namespace PathFindingVisualizer.Pages
{
    ...
    public class Node
    {
        ...
        public static int col_num { get; set; } = 76;
        public static int row_num { get; set; } = 31;
        public static int start_row { get; set; } = 14;
        public static int start_col { get; set; } = 27;
        public static int finish_row { get; set; } = 14;
        public static int finish_col { get; set; } = 48;
